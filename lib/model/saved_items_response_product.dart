...
SavedItemsResponseProduct savedItemsResponseProductFromJson(String str) => SavedItemsResponseProduct.fromJson(json.decode(str));

String savedItemsResponseProductToJson(SavedItemsResponseProduct data) => json.encode(data.toJson());

class SavedItemsResponseProduct {
  int status;
  String message;
  List<Datum> data;

  SavedItemsResponseProduct({
    required this.status,
    required this.message,
    required this.data,
  });

  factory SavedItemsResponseProduct.fromJson(Map<String, dynamic> json) => SavedItemsResponseProduct(
